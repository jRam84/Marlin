/** This is an attempt at making the Firmware part for the CR-10 actually EASY. 
Everything most users need will be listed at the start of the file. 
Advanced users can still do changes to suit their own needs after the Easy Config part.
To enable things delete the 2 // before #define, to disable add 2 // before #enable.

This is based on Jim Brown's Easy Config for the Tevo Tarantula.
*/

/**
 * AXIS DIRECTION
 * After Flashing Firmware use either the LCD or Jog Controls in your Slicer to move the Axis slightly
 * If they are not moving the right way then comment out or delete comment
*/
